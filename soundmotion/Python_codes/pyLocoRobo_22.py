...
from LocoContext12 import locoContext
...
###CB1.3.2 --- Assign action to Waveshaping2 combobox
	...
	def setVariables(self):
		...
		self.context = {'user': [], 'robot': [], 'userinput':''}
