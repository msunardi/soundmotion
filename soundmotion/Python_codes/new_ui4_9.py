...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.label_RobotsResponse.setGeometry(QtCore.QRect(10, 250, 419, 19))
		font = QtGui.QFont()
		font.setWeight(75)
		font.setBold(True)
		...
		self.textBrowserRobotResponse.setGeometry(QtCore.QRect(10, 275, 419, 129))
		self.textBrowserRobotResponse.setObjectName("textBrowserRobotResponse")
		self.label_say = QtGui.QLabel(self.frame_Center)
		self.label_say.setGeometry(QtCore.QRect(10, 410, 419, 19))
		font = QtGui.QFont()
		font.setWeight(75)
		font.setBold(True)
		...
		self.lineEditUserDialogue.setGeometry(QtCore.QRect(10, 430, 419, 28))
		self.lineEditUserDialogue.setObjectName("lineEditUserDialogue")
		self.frame = QtGui.QFrame(self.mainTab_0)
		self.frame.setGeometry(QtCore.QRect(670, 280, 180, 260))
		...
		self.frameMotionMusic = QtGui.QFrame(self.mainTab_0)
		self.frameMotionMusic.setGeometry(QtCore.QRect(670, 20, 180, 250))
		self.frameMotionMusic.setFrameShape(QtGui.QFrame.StyledPanel)
		self.frameMotionMusic.setFrameShadow(QtGui.QFrame.Raised)
		self.frameMotionMusic.setObjectName("frame")

		self.labelMotion = QtGui.QLabel(self.frameMotionMusic)
		self.labelMotion.setGeometry(QtCore.QRect(10, 5, 100, 25))
		self.labelMotion.setObjectName("labelMotion")
		self.labelMotion.setText("Select Motion #:")
		self.labelMotion.setFont(font)
		self.labelMusic = QtGui.QLabel(self.frameMotionMusic)
		self.labelMusic.setGeometry(QtCore.QRect(10, 70, 100, 25))
		self.labelMusic.setObjectName("labelMotion")
		self.labelMusic.setText("Select Music:")
		self.labelMusic.setFont(font)

		self.comboBoxMotion = QtGui.QComboBox(self.frameMotionMusic)
		self.comboBoxMotion.setGeometry(QtCore.QRect(10, 30, 100, 25))
		self.comboBoxMotion.setObjectName("comboBoxMotion")
		self.pushButtonMotion = QtGui.QPushButton(self.frameMotionMusic)
		self.pushButtonMotion.setGeometry(QtCore.QRect(120, 30, 50, 25))
		self.pushButtonMotion.setText("Move It!")

		self.comboBoxMusic = QtGui.QComboBox(self.frameMotionMusic)
		self.comboBoxMusic.setGeometry(QtCore.QRect(10, 95, 160, 25))
		...
		self.comboBoxMotionSignal = QtGui.QComboBox(self.mainTab_1)
		self.comboBoxMotionSignal.setGeometry(QtCore.QRect(250, 10, 500, 25))
		self.comboBoxMotionSignal.setObjectName("comboBoxMotionSignal")
	   
		self.pushButtonLoadMotion = QtGui.QPushButton(self.mainTab_1)
		self.pushButtonLoadMotion.setGeometry(QtCore.QRect(770, 10, 80, 30))
		self.pushButtonLoadMotion.setText("Load Motion")
		...
		self.tab_00 = QtGui.QWidget()
		self.tab_00.setObjectName("tab_00")
		self.tabWidget.addTab(self.tab_00, "xxx")
		...
		self.gainLabel.setObjectName("gainLabel")#=== Resampling feature
	...
	def createBackend(self):	
		self.tab_00 = QtGui.QWidget()
		self.tab_00.setObjectName("tab_00")
		self.interpFrame = QtGui.QFrame(self.tab_00)
		self.interpFrame.setGeometry(QtCore.QRect(10, 10, 200, 200))
		...
		self.interpTensionLabel.setGeometry(QtCore.QRect(20, 20, 80, 25))
		self.interpTensionLabel.setText("Tension")
		self.interpTensionSpinBox = QtGui.QSpinBox(self.interpFrame)
		self.interpTensionSpinBox.setGeometry(QtCore.QRect(100, 20, 50, 25))
		self.interpTensionSpinBox.setMinimum(-5)
		self.interpTensionSpinBox.setMaximum(5)
		self.interpBiasLabel = QtGui.QLabel(self.interpFrame)
		self.interpBiasLabel.setGeometry(QtCore.QRect(20, 60, 80, 25))
		self.interpBiasLabel.setText("Bias")
		self.interpBiasSpinBox = QtGui.QSpinBox(self.interpFrame)
		self.interpBiasSpinBox.setGeometry(QtCore.QRect(100, 60, 50, 25))
		self.interpBiasSpinBox.setMinimum(-5)
		self.interpBiasSpinBox.setMaximum(5)
		self.interpContinuityLabel = QtGui.QLabel(self.interpFrame)
		self.interpContinuityLabel.setGeometry(QtCore.QRect(20, 100, 80, 25))
		self.interpContinuityLabel.setText("Continuity")
		self.interpContinuitySpinBox = QtGui.QSpinBox(self.interpFrame)
		self.interpContinuitySpinBox.setGeometry(QtCore.QRect(100, 100, 50, 25))
		self.interpContinuitySpinBox.setMinimum(-5)
		self.interpContinuitySpinBox.setMaximum(5)
		self.interpButton = QtGui.QPushButton(self.interpFrame)
		self.interpButton.setGeometry(QtCore.QRect(40, 150, 100, 25))
		self.interpButton.setText("Interpolate!")
		
		self.tabWidget.addTab(self.tab_00, "Interpolation")
