...
Em = emote()
print "Weight,  Time,  Space,  Flow,  ti,  v0,  v1,  texp,  elbowangle,  vt__ " 
for w in range(-10, 11, 5):
    for t in range(-10, 11, 5):
        for s in range(-10, 11, 5):
            for f in range(-10, 11, 5):
                #print "Weight =", w*0.1, "; Time =", t*0.1, "; Space =", s*0.1, "; Flow =", f*.1, 
                print w*0.1, ",", t*0.1, ",", s*0.1, ",", f*.1, ",",  

                J = Em.efforts((w*0.1), (t*0.1), (s*0.1), (f*0.1))
                in_ti = Em.ti(J)
                in_v0 = Em.v0(J)
                in_v1 = Em.v1(J)
                in_texp = Em.texp(J)
                ...
                print in_ti,",", in_v0, ",", in_v1, ",", in_texp, ",", in_elbow_angle, ",", in_vt__
