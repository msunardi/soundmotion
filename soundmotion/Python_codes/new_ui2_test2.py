...
class MyForm(QtGui.QMainWindow):
    ...
    def applySignalSlot(self, how_many):
        ...
        QtCore.QObject.connect(self.ui.gainSliders[0], QtCore.SIGNAL("valueChanged(int)"), self.adjustGain)
    ...
    def adjustGain(self):
        ...
        """
        ms = self.ms.mrfDoItAll(self.newData, 0, 0, self.ui.gainSliders[0].value())
        print self.ui.gainSliders[0].value()

        self.ui.qwtPlot.changeCurve(0, ms[0])
        #pass
