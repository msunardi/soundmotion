...
from math import *
import numpy
from new_ui3_copy6 import Ui_MainWindow
...
#====== SIGNAL SECTION
    ...
    def loadData(self):
        ...
        #self.allData = numpy.array(self.ms.read("/home/msunardi/Documents/thesis-stuff/KHR-1-motions/push_ups_data.csv"))
        self.allData = numpy.array(self.ms.read("/home/msunardi/Documents/thesis-stuff/KHR-1-motions/home.csv"))
    ...
    def applyWaveshape(self):
        try:
            ...
            for i in range(len(data)):
                tmpData = numpy.array(numpy.add(data[i], numpy.multiply(data[i], numpy.multiply(self.y, self.ui.expSpinBox.value()))))
                tmp.append(tmpData)
