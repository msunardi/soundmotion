...
pid = os.fork()
if pid == 0:
# Option 1. With system
    os.system("python pyopencv-test5-facedetect.py > /dev/null")
    exit();
# Option 2. With exec. NOt quite working
#    os.execvp("python", ["python", "pyopencv-test5-facedetect.py", ">", "/dev/null"])
