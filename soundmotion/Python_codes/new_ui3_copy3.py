...
class Ui_MainWindow(object):
    ...
    def addGainSliders(self, how_many):
        ...
        for i in range(how_many):
            ...
            self.gainLineEdits.append(QtGui.QDoubleSpinBox)
            self.gainLineEdits[i] = QtGui.QDoubleSpinBox(self.gainFrame)
            self.gainLineEdits[i].setGeometry(QtCore.QRect(10 + i*60, 50, 41, 28))
            self.gainLineEdits[i].setObjectName("weightLineEdit")
            self.gainLineEdits[i].setValue(self.gainSliders[i].value()*0.1)
