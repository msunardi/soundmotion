...
from pyMiniUix_v7 import Ui_MainWindow
...
class MyForm(QtGui.QMainWindow):
	...
	def talkToRobot(self):
		...
		self.ui.chatArea.append("<b><font color=blue>%s</font></b>" % (response))
		self.ui.chatArea.append("<br>")
		
		if self.scriptindex >= len(self.SCRIPT):
			self.scriptindex = 0
		
		for i in len(self.SCRIPT[self.scriptindex]):
			self.ui.chatArea.append("<b><font color=blue>%d. %s</font></b>" % (i, self.SCRIPT[self.scriptindex][i]))
