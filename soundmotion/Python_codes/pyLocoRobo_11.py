...
Global variables:
    ...
    - self.allData          (Type: list) For loaded motion data from file
...
###CB1.3.2 --- Assign action to Waveshaping2 combobox
    ...
    def setVariables(self):
        ...
        self.fparams = {'motion': [], 'interp': {'bias': 0, 'tension': 0, 'continuity': 0}, 'rate': 1, 'gains': [], 'waveshapef': '', 'waveshapeg': [], 'awareness': {'orientation':"", 'position':"", 'target':""}}
    ...
    def adjustGain(self, value):
        ...
        self.ms.DATA = self.ms.interpolate(self.allData, self.interpBias, self.interpTension, self.interpContinuity)
    ...
    def restoreData(self):
        tmp = self.ms.interpolate(self.allData, self.interpBias, self.interpTension, self.interpContinuity)
