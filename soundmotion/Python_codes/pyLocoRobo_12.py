...
import resampling, autosynthesis
...
###CB1.3.2 --- Assign action to Waveshaping2 combobox
    ...
    def setVariables(self):
        ...
        self.fparam = {'motion': [], 'interp': {'bias': 0, 'tension': 0, 'continuity': 0}, 'rate': 1, 'gains': [], 'waveshapef': '', 'waveshapeg': [], 'awareness': {'orientation':"", 'position':"", 'target':""}}
