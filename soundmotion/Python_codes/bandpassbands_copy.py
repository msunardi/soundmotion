...
print "Result bands: ", bands[0]

(cA, cD) = pywt.dwt(bands[0][0], 'db1')
print "cA = ", cA
print "cD = ", cD

coeffs = pywt.wavedec(bands[0][0], 'db2', level=None)
print "COEFFS length = ", len(coeffs)
cA2, cD2, cD1 = coeffs
print "cA2 = ", cA2
print "cD1 = ", cD1
print "cD2 = ", cD2
