...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.gridLayoutWidget_3.setGeometry(QtCore.QRect(450, 290, 191, 91))
	...
	def addGainSliders(self, how_many):
		...
		for i in range(how_many):
			...
			self.gainLabels[i] = QtGui.QLabel(self.mrfFrame)
			self.gainLabels[i].setGeometry(QtCore.QRect(j*60, 0, 54, 18))
			...
			self.gainSliders.append(QtGui.QSlider(self.mrfFrame))
			self.gainSliders[i].setGeometry(QtCore.QRect(20 + j*60 , 40, 20, 80))
			...
			self.gainLineEdits[i] = QtGui.QLineEdit(self.mrfFrame)
			self.gainLineEdits[i].setGeometry(QtCore.QRect(10 + j*60, 20, 41, 20))
