...
def main():
	...
	chan5 = processpos2(analysis_drum, servo_id=1, beat=timeperbeat)
	...
	print "Newmotion:", newmotion[:20]
	newmotion_ = waitToComplete(formatforasc16(newmotion, servo_id=1))
	print "Formatted newmotion:", newmotion_[:20]
	...
	#pid = Popen(["python", "playmidi.py"])	# << uncomment to midi
	#time.sleep(5)  # << uncomment to make music play on time
